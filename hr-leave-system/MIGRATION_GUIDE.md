...
| 17 | `migration_app_v39.sql` | **Finds and repairs a half-written carry-forward** — where the Carry Forward line shows days the balance does not actually hold. Adds `carry_health_check()` and `repair_carry_ledger()` |
